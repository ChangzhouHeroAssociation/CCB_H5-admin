...
public class AutoGeneratorPlus {
     ...
     * 数据连接相关，需要手动设置
     */
    private static final String URL = "jdbc:mysql://39.96.56.19:3306/ccb?serverTimezone=GMT%2B8&characterEncoding=utf-8";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "Huike123456";
